...
// para la página de revisión /titulaciones/propuestas y para /titulaciones/asignacion-guia
// (agrupa por equipo vía `estudiante.grupo` y lee el guía ya asignado vía `comision`). A
// diferencia de GET /api/estudiante/propuestas (que filtra por la sesión del propio estudiante),
// acá no hay filtro: cualquier rol con permiso 'ver' en cualquiera de las dos rutas ve todas.
