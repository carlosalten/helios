...
// /horario, /horario/profesor y /reservas/horario (para dibujar la plantilla de horas de su
// matriz, de solo lectura). Basta con tener 'ver' en cualquiera de las cinco — un Apoyo
// Docente con permiso en /reservas/horario pero no en /bloques también necesita esta
// plantilla para que la matriz no aparezca vacía.
